...
$quer = "SELECT * FROM avis WHERE id_avis='$id'";
...
<div class="Container">
          ...
          <div class="leftContainer">     
            <form name="formulaire" class="formulaire" method="post">
              <div class="nom_email">
                <div class="block">
                  <label>Nom</label><span type="text" id="name" name="nom" span><p>'.$li[4].'</p></span>
                </div>
                <div class="block">

              
                <label>Status</label>
                <input type="text" name="num_tel" class="login-style" value="'.$li[3].'" autocomplete="off" READONLY required>                     
              ...
              <div class="secondBlock">
                ...
                <div class="second">
                <label>Note</label><!--input type="text" class="login-style"  value="'.$li[2].'" READONLY required--> 
                <span>
                ';
                for($t=0;$t<5;$t++){
                  if($t<$li[2]){
              ...
              <div class="thirdBlock">
                <div class="first">
                  ...
                  <TEXTAREA id="text" ROWS="5" COLS="70" name="num_tel" id="kbr" class="name-style" READONLY >'.$li[1].'</TEXTAREA>  
                </div>
              </div>
              <div class="thirdBlock">
                <div class="first">
                <td > <a id="left" onclick=\' javascript: return confirm("Êtes-vous sûr d&apos;affiche l&apos;avis de '.$li[4].' dans l&apos;application ?")\'href="../avis/accpt.php?accpt='.$li[0].'"><image class="image_delete" id="k" src="../image/oui.png" ></a></td>
                <td > <a id="left" onclick=\' javascript: return confirm("Êtes-vous sûr de masque l&apos;avis de '.$li[4].' dans l&apos;application ?")\'href="../avis/refs.php?refs='.$li[0].'"><image class="image_delete" id="k" src="../image/non.png" ></a></td>
                </div>
              </div>
              
              <div class="submit1">
              <button type="submit" name="submit" class="submit"><a href="Avis.php">Retour</a></button>
              </div>
            </form>
          </div>
